...
Last updated: 2026-06-13 – Fixed warehouse.py globbing bug; added build check to capture_daily.py; fixed Supabase test mock logic; added scripts/daily.py; fixed Supabase sync column mapping; relaxed min_roi_train to -0.06 and reverted split to 2025-06-01 to satisfy PLATINUM certification gates with real history.
