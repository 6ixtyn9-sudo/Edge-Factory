...
- unmatched picks: 81
- picks with fewer than two snapshots: 133

## By rule

- `2way-unanimous avg_p>=60`: n=83, two_prices=59, avg_raw=-0.004576, avg_ip=0.000735, beat_rate=0.067797
- `2way-unanimous avg_p>=70`: n=199, two_prices=141, avg_raw=-0.001277, avg_ip=0.000806, beat_rate=0.184397
- `ml-meta avg_p>=55`: n=643, two_prices=575, avg_raw=-0.003774, avg_ip=0.001906, beat_rate=0.166957
- `ml-meta avg_p>=60`: n=115, two_prices=84, avg_raw=0.033333, avg_ip=-0.005109, beat_rate=0.083333
- `ml-meta avg_p>=65`: n=35, two_prices=22, avg_raw=-0.002727, avg_ip=0.000487, beat_rate=0.045455
...
- `CAUTION`: n=108, two_prices=95, avg_raw=-0.001158, avg_ip=0.00109, beat_rate=0.2
- `CERTIFIED_CLEAN`: n=137, two_prices=117, avg_raw=0.021453, avg_ip=-0.002719, beat_rate=0.188034
- `SKIPPED_VETO`: n=565, two_prices=490, avg_raw=-0.003143, avg_ip=0.001538, beat_rate=0.165306
- `WATCHLIST_NO_ODDS`: n=67, two_prices=2, avg_raw=0.0, avg_ip=0.0, beat_rate=0.0
- `WATCHLIST_SUSPECT_PRICE`: n=27, two_prices=18, avg_raw=0.000556, avg_ip=-0.000346, beat_rate=0.055556
- `WATCHLIST_UNCORROBORATED_PRICE`: n=251, two_prices=222, avg_raw=-0.003153, avg_ip=0.001217, beat_rate=0.063063
