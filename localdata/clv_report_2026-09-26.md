...
- total unique picks: 1146
- picks with at least two prices: 952
- average raw odds delta: 0.00021
- average implied-probability delta: 0.000824
- beat-later-price rate: 0.143908
- beat-later-price sample: 952
- unmatched picks: 80
- picks with fewer than two snapshots: 114

## By rule

- `2way-unanimous avg_p>=60`: n=76, two_prices=59, avg_raw=-0.004068, avg_ip=0.000415, beat_rate=0.050847
- `2way-unanimous avg_p>=70`: n=199, two_prices=141, avg_raw=-0.001277, avg_ip=0.000806, beat_rate=0.184397
- `ml-meta avg_p>=55`: n=632, two_prices=575, avg_raw=-0.003774, avg_ip=0.001906, beat_rate=0.166957
...
- `CAUTION`: n=105, two_prices=95, avg_raw=-0.000421, avg_ip=0.000777, beat_rate=0.189474
- `CERTIFIED_CLEAN`: n=132, two_prices=117, avg_raw=0.021453, avg_ip=-0.002719, beat_rate=0.188034
- `SKIPPED_VETO`: n=557, two_prices=490, avg_raw=-0.003224, avg_ip=0.00156, beat_rate=0.165306
...
- `WATCHLIST_UNCORROBORATED_PRICE`: n=249, two_prices=222, avg_raw=-0.003153, avg_ip=0.001217, beat_rate=0.063063
