...
- total unique picks: 453
- picks with at least two prices: 411
- average raw odds delta: 0.001852
- average implied-probability delta: -0.000682
- beat-later-price rate: 0.138686
- beat-later-price sample: 411
- unmatched picks: 23
...
- `ml-meta avg_p>=55`: n=170, two_prices=157, avg_raw=0.002229, avg_ip=-0.000372, beat_rate=0.184713
...
- `CAUTION`: n=75, two_prices=69, avg_raw=0.003478, avg_ip=-0.000196, beat_rate=0.115942
- `CERTIFIED_CLEAN`: n=22, two_prices=22, avg_raw=-0.001, avg_ip=0.0015, beat_rate=0.318182
- `SKIPPED_VETO`: n=247, two_prices=238, avg_raw=0.002071, avg_ip=-0.001215, beat_rate=0.155462
