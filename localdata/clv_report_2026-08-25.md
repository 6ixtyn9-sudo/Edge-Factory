...
- `ml-meta avg_p>=55`: n=168, two_prices=150, avg_raw=0.003067, avg_ip=-0.000827, beat_rate=0.18
...
- `CAUTION`: n=75, two_prices=67, avg_raw=0.003582, avg_ip=-0.000202, beat_rate=0.119403
- `CERTIFIED_CLEAN`: n=22, two_prices=22, avg_raw=-0.001, avg_ip=0.0015, beat_rate=0.318182
- `SKIPPED_VETO`: n=245, two_prices=233, avg_raw=0.002588, avg_ip=-0.001523, beat_rate=0.150215
