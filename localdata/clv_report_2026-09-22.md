...
- total unique picks: 1107
- picks with at least two prices: 928
- average raw odds delta: 0.001056
- average implied-probability delta: 0.000623
- beat-later-price rate: 0.144397
- beat-later-price sample: 928
- unmatched picks: 70
- picks with fewer than two snapshots: 109

## By rule

- `2way-unanimous avg_p>=60`: n=6, two_prices=6, avg_raw=0.033333, avg_ip=-0.020532, beat_rate=0.0
- `2way-unanimous avg_p>=70`: n=216, two_prices=156, avg_raw=-0.001603, avg_ip=0.001145, beat_rate=0.179487
- `ml-meta avg_p>=55`: n=619, two_prices=565, avg_raw=-0.003345, avg_ip=0.001836, beat_rate=0.166372
- `ml-meta avg_p>=60`: n=137, two_prices=105, avg_raw=0.027905, avg_ip=-0.004687, beat_rate=0.057143
...
- `CERTIFIED_CLEAN`: n=120, two_prices=105, avg_raw=0.023143, avg_ip=-0.002786, beat_rate=0.190476
- `SKIPPED_VETO`: n=559, two_prices=499, avg_raw=-0.002204, avg_ip=0.001347, beat_rate=0.166333
