...
- **1X2 Pick**: Selected `HOME` @ 1.32 -> 🟢 WON (Expected prob: 75.5%)
  ...
  - **🔥 Possible Events (graded)**:
    - [🟢 HIT] **Match Over 1.5 Goals**: expected 88.6% (Actual: 4 goals)
    - [🟢 HIT] **Match Over 2.5 Goals**: expected 74.2% (Actual: 4 goals)
...
- **1X2 Pick**: Selected `HOME` @ 1.33 -> 🔴 LOST (Expected prob: 75.5%)
  ...
  - **Top Scores**: [🔴 MISS] 2-0 (12.0%), [🔴 MISS] 3-0 (11.8%)
  - **🔥 Possible Events (graded)**:
    - [🟢 HIT] **Match Over 1.5 Goals**: expected 86.8% (Actual: 4 goals)
    - [🟢 HIT] **Match Over 2.5 Goals**: expected 68.1% (Actual: 4 goals)
    - [🟢 HIT] **Both Teams to Score - Yes (BTTS-Yes)**: expected 64.1% (Actual: BTTS-Yes)
...
- **1X2 Pick**: Selected `HOME` @ 1.31 -> 🟢 WON (Expected prob: 68.3%)
  ...
  - **🔥 Possible Events (graded)**:
    ...
    - [🔴 MISS] **Both Teams to Score - Yes (BTTS-Yes)**: expected 51.7% (Actual: BTTS-No)
    ...
    - [🟢 HIT] **Match Over 2.5 Goals**: expected 37.3% (Actual: 3 goals)
...
- **1X2 Pick**: Selected `HOME` @ 1.33 -> 🟢 WON (Expected prob: 80.5%)
  ...
  - **🔥 Possible Events (graded)**:
    ...
    - [🔴 MISS] **Both Teams to Score - Yes (BTTS-Yes)**: expected 41.9% (Actual: BTTS-No)
...
- **1X2 Pick**: Selected `HOME` @ 1.4 -> 🟢 WON (Expected prob: 69.4%)
  ...
  - **🔥 Possible Events (graded)**:
    ...
    - [🟢 HIT] **Both Teams to Score - Yes (BTTS-Yes)**: expected 43.9% (Actual: BTTS-Yes)
...
- **1X2 Pick**: Selected `HOME` @ 1.4 -> 🟢 WON (Expected prob: 68.0%)
  ...
  - **🔥 Possible Events (graded)**:
    ...
    - [🟢 HIT] **Both Teams to Score - Yes (BTTS-Yes)**: expected 52.0% (Actual: BTTS-Yes)
...
- **1X2 Pick**: Selected `HOME` @ n/a -> 🟢 WON (Expected prob: 71.0%)
  ...
  - **🔥 Possible Events (graded)**:
    - [🔴 MISS] **Match Over 2.5 Goals**: expected 56.3% (Actual: 2 goals)
    - [🟢 HIT] **Goal Range 2-3**: expected 46.5% (Actual: 2 goals)
    - [🔴 MISS] **Both Teams to Score - Yes (BTTS-Yes)**: expected 54.1% (Actual: BTTS-No)
...
- **1X2 Pick**: Selected `HOME` @ 1.23 -> 🟢 WON (Expected prob: 75.5%)
  ...
  - **Top Scores**: [🔴 MISS] 2-0 (12.0%), [🔴 MISS] 3-0 (11.8%)
  - **🔥 Possible Events (graded)**:
    - [🔴 MISS] **Match Over 1.5 Goals**: expected 90.1% (Actual: 1 goals)
    - [🔴 MISS] **Match Over 2.5 Goals**: expected 74.0% (Actual: 1 goals)
    - [🔴 MISS] **Both Teams to Score - Yes (BTTS-Yes)**: expected 53.9% (Actual: BTTS-No)
