...
- `ml-meta avg_p>=55`: n=406, two_prices=377, avg_raw=0.000769, avg_ip=0.000218, beat_rate=0.183024
...
- `CERTIFIED_CLEAN`: n=66, two_prices=58, avg_raw=0.047379, avg_ip=-0.007268, beat_rate=0.241379
- `SKIPPED_VETO`: n=409, two_prices=389, avg_raw=7.2e-05, avg_ip=-4.6e-05, beat_rate=0.174807
