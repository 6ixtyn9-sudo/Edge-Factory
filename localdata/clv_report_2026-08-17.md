...
- average raw odds delta: 0.003095
...
- `ml-meta avg_p>=55`: n=83, two_prices=77, avg_raw=0.008961, avg_ip=-0.003109, beat_rate=0.233766
...
- `CAUTION`: n=53, two_prices=50, avg_raw=0.0024, avg_ip=-2.8e-05, beat_rate=0.14
- `CERTIFIED_CLEAN`: n=22, two_prices=22, avg_raw=-0.001, avg_ip=0.0015, beat_rate=0.318182
- `SKIPPED_VETO`: n=165, two_prices=158, avg_raw=0.004892, avg_ip=-0.00255, beat_rate=0.14557
