...
- `2way-unanimous avg_p>=70`: n=167, two_prices=147, avg_raw=0.001048, avg_ip=-0.000601, beat_rate=0.122449
- `2way-unanimous min_p>=60 avg_p>=65`: n=11, two_prices=8, avg_raw=0.0, avg_ip=0.0, beat_rate=0.0
- `3way-unanimous avg_p>=65`: n=31, two_prices=30, avg_raw=-0.001, avg_ip=-9.5e-05, beat_rate=0.033333
- `ml-meta avg_p>=55`: n=283, two_prices=262, avg_raw=0.000344, avg_ip=0.000602, beat_rate=0.187023
...
- `SKIPPED_VETO`: n=323, two_prices=309, avg_raw=0.000252, avg_ip=4.6e-05, beat_rate=0.165049
- `WATCHLIST_NO_ODDS`: n=32, two_prices=0, avg_raw=None, avg_ip=None, beat_rate=None
- `WATCHLIST_SUSPECT_PRICE`: n=7, two_prices=6, avg_raw=-0.006667, avg_ip=0.005316, beat_rate=0.166667
- `WATCHLIST_UNCORROBORATED_PRICE`: n=87, two_prices=82, avg_raw=-0.00122, avg_ip=0.000895, beat_rate=0.073171
