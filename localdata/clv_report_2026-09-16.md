...
- `2way-unanimous avg_p>=70`: n=191, two_prices=148, avg_raw=-0.000676, avg_ip=0.000762, beat_rate=0.155405
- `ml-meta avg_p>=55`: n=562, two_prices=510, avg_raw=-0.002804, avg_ip=0.001551, beat_rate=0.170588
...
- `ml-meta avg_p>=70`: n=30, two_prices=19, avg_raw=0.01, avg_ip=-0.004243, beat_rate=0.105263
...
- `CAUTION`: n=108, two_prices=96, avg_raw=0.006667, avg_ip=-0.0016, beat_rate=0.135417
- `CERTIFIED_CLEAN`: n=83, two_prices=69, avg_raw=0.043623, avg_ip=-0.007529, beat_rate=0.188406
- `SKIPPED_VETO`: n=498, two_prices=461, avg_raw=-0.002972, avg_ip=0.001516, beat_rate=0.180043
