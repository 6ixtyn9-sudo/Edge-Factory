...
- picks with at least two prices: 758
- average raw odds delta: 0.003697
- average implied-probability delta: -0.000324
- beat-later-price rate: 0.155673
- beat-later-price sample: 758
- unmatched picks: 55
...
- `2way-unanimous avg_p>=70`: n=176, two_prices=144, avg_raw=0.0, avg_ip=6e-06, beat_rate=0.173611
- `2way-unanimous min_p>=60 avg_p>=65`: n=11, two_prices=8, avg_raw=0.0, avg_ip=0.0, beat_rate=0.0
- `3way-unanimous avg_p>=65`: n=8, two_prices=8, avg_raw=0.00125, avg_ip=-0.000479, beat_rate=0.0
- `ml-meta avg_p>=55`: n=463, two_prices=430, avg_raw=-0.000209, avg_ip=0.000526, beat_rate=0.17907
...
- `CAUTION`: n=119, two_prices=109, avg_raw=0.005596, avg_ip=-0.000631, beat_rate=0.155963
- `CERTIFIED_CLEAN`: n=74, two_prices=65, avg_raw=0.0412, avg_ip=-0.006123, beat_rate=0.230769
- `SKIPPED_VETO`: n=421, two_prices=397, avg_raw=-0.00072, avg_ip=0.000293, beat_rate=0.186398
- `WATCHLIST_NO_ODDS`: n=46, two_prices=0, avg_raw=None, avg_ip=None, beat_rate=None
- `WATCHLIST_SUSPECT_PRICE`: n=27, two_prices=20, avg_raw=-0.008, avg_ip=0.003972, beat_rate=0.1
