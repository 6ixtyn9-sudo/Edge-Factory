...
- `ml-meta avg_p>=55`: n=22, two_prices=20, avg_raw=0.005, avg_ip=-0.002402, beat_rate=0.35
...
- `CAUTION`: n=29, two_prices=27, avg_raw=0.001481, avg_ip=0.001001, beat_rate=0.111111
- `CERTIFIED_CLEAN`: n=15, two_prices=15, avg_raw=-0.022, avg_ip=0.007893, beat_rate=0.4
- `SKIPPED_VETO`: n=123, two_prices=115, avg_raw=0.003504, avg_ip=-0.002033, beat_rate=0.121739
