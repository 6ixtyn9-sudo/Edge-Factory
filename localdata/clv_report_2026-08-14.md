...
- total unique picks: 226
- picks with at least two prices: 211
- average raw odds delta: 0.00264
...
- `2way-unanimous avg_p>=70`: n=89, two_prices=83, avg_raw=0.001253, avg_ip=-0.000942, beat_rate=0.144578
...
- `ml-meta avg_p>=55`: n=33, two_prices=32, avg_raw=0.015937, avg_ip=-0.006036, beat_rate=0.25
- `ml-meta avg_p>=60`: n=2, two_prices=1, avg_raw=0.004, avg_ip=-0.001924, beat_rate=0.0
- `ml-meta avg_p>=65`: n=2, two_prices=1, avg_raw=0.074, avg_ip=-0.031343, beat_rate=0.0
- `ml-meta avg_p>=70`: n=2, two_prices=1, avg_raw=0.0, avg_ip=0.0, beat_rate=0.0

## By bucket

- `CAUTION`: n=32, two_prices=30, avg_raw=0.003, avg_ip=0.00034, beat_rate=0.1
- `CERTIFIED_CLEAN`: n=20, two_prices=20, avg_raw=-0.0008, avg_ip=0.001552, beat_rate=0.35
- `SKIPPED_VETO`: n=134, two_prices=128, avg_raw=0.004789, avg_ip=-0.002849, beat_rate=0.109375
