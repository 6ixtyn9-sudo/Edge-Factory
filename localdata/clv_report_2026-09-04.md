...
- total unique picks: 706
- picks with at least two prices: 634
- average raw odds delta: 0.005309
- average implied-probability delta: -0.000776
- beat-later-price rate: 0.157729
- beat-later-price sample: 634
- unmatched picks: 40
...
- `ml-meta avg_p>=55`: n=351, two_prices=328, avg_raw=0.001006, avg_ip=0.000188, beat_rate=0.192073
...
- `ou25-unanimous-2way-sa avg_p>=70`: n=24, two_prices=22, avg_raw=0.0, avg_ip=3.1e-05, beat_rate=0.045455

## By bucket

- `CAUTION`: n=107, two_prices=98, avg_raw=0.008061, avg_ip=-0.001743, beat_rate=0.142857
- `CERTIFIED_CLEAN`: n=55, two_prices=52, avg_raw=0.052269, avg_ip=-0.007512, beat_rate=0.25
- `SKIPPED_VETO`: n=369, two_prices=354, avg_raw=5.1e-05, avg_ip=-6.8e-05, beat_rate=0.177966
...
- `WATCHLIST_UNCORROBORATED_PRICE`: n=108, two_prices=103, avg_raw=-0.001165, avg_ip=0.000861, beat_rate=0.07767
