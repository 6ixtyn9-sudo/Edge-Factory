...
- unmatched picks: 37
- picks with fewer than two snapshots: 42
...
- `ml-meta avg_p>=55`: n=322, two_prices=292, avg_raw=0.000582, avg_ip=0.000665, beat_rate=0.195205
- `ml-meta avg_p>=60`: n=50, two_prices=40, avg_raw=0.0796, avg_ip=-0.015119, beat_rate=0.025
- `ml-meta avg_p>=65`: n=17, two_prices=10, avg_raw=-0.0012, avg_ip=0.001833, beat_rate=0.2
- `ml-meta avg_p>=70`: n=17, two_prices=13, avg_raw=0.016154, avg_ip=-0.008068, beat_rate=0.076923
...
- `CAUTION`: n=98, two_prices=89, avg_raw=0.007753, avg_ip=-0.001809, beat_rate=0.146067
- `CERTIFIED_CLEAN`: n=51, two_prices=46, avg_raw=0.061261, avg_ip=-0.009516, beat_rate=0.217391
- `SKIPPED_VETO`: n=353, two_prices=332, avg_raw=-0.000789, avg_ip=0.000565, beat_rate=0.180723
