...
- `ml-meta avg_p>=55`: n=316, two_prices=292, avg_raw=0.000582, avg_ip=0.000665, beat_rate=0.195205
- `ml-meta avg_p>=60`: n=49, two_prices=40, avg_raw=0.0796, avg_ip=-0.015119, beat_rate=0.025
...
- `SKIPPED_VETO`: n=349, two_prices=332, avg_raw=-0.000789, avg_ip=0.000565, beat_rate=0.180723
- `WATCHLIST_NO_ODDS`: n=34, two_prices=0, avg_raw=None, avg_ip=None, beat_rate=None
- `WATCHLIST_SUSPECT_PRICE`: n=11, two_prices=8, avg_raw=-0.005, avg_ip=0.003987, beat_rate=0.125
