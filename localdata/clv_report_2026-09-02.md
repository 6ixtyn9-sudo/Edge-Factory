...
- total unique picks: 670
- picks with at least two prices: 601
- average raw odds delta: 0.005235
- average implied-probability delta: -0.000588
- beat-later-price rate: 0.156406
...
- `2way-unanimous avg_p>=70`: n=167, two_prices=147, avg_raw=0.000435, avg_ip=-0.000287, beat_rate=0.14966
- `2way-unanimous min_p>=60 avg_p>=65`: n=11, two_prices=8, avg_raw=0.0, avg_ip=0.0, beat_rate=0.0
- `3way-unanimous avg_p>=65`: n=24, two_prices=23, avg_raw=-0.001304, avg_ip=-0.000123, beat_rate=0.043478
- `ml-meta avg_p>=55`: n=322, two_prices=300, avg_raw=0.000733, avg_ip=0.000543, beat_rate=0.193333
...
- `CAUTION`: n=99, two_prices=90, avg_raw=0.007778, avg_ip=-0.001845, beat_rate=0.144444
- `CERTIFIED_CLEAN`: n=51, two_prices=48, avg_raw=0.058292, avg_ip=-0.009009, beat_rate=0.229167
- `SKIPPED_VETO`: n=352, two_prices=338, avg_raw=-0.000568, avg_ip=0.000448, beat_rate=0.177515
