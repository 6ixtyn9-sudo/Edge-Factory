...
- average raw odds delta: 0.001
- average implied-probability delta: 0.000688
- beat-later-price rate: 0.147778
...
- `CAUTION`: n=97, two_prices=86, avg_raw=0.003488, avg_ip=-0.000478, beat_rate=0.186047
- `CERTIFIED_CLEAN`: n=123, two_prices=108, avg_raw=0.0225, avg_ip=-0.002709, beat_rate=0.185185
- `SKIPPED_VETO`: n=538, two_prices=480, avg_raw=-0.002396, avg_ip=0.001461, beat_rate=0.170833
...
- `WATCHLIST_UNCORROBORATED_PRICE`: n=223, two_prices=200, avg_raw=-0.00345, avg_ip=0.001286, beat_rate=0.065
