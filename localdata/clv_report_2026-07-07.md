# Edge Factory — CLV report (2026-06-07 to 2026-07-07)

## Overall

- total unique picks: 98
- picks with at least two prices: 79
- average raw odds delta: 0.043924
- average implied-probability delta: -0.00911
- beat-later-price rate: 0.0
- beat-later-price sample: 79
- unmatched picks: 16
...
- `2way-unanimous avg_p>=70`: n=21, two_prices=12, avg_raw=0.0, avg_ip=0.0, beat_rate=0.0
- `3way-unanimous avg_p>=65`: n=33, two_prices=29, avg_raw=0.103103, avg_ip=-0.018448, beat_rate=0.0
- `3way-unanimous home-only avg_p>=65`: n=3, two_prices=3, avg_raw=0.153333, avg_ip=-0.057437, beat_rate=0.0
...
- `SKIPPED_VETO`: n=56, two_prices=47, avg_raw=0.073191, avg_ip=-0.014859, beat_rate=0.0
