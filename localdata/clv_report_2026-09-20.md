...
- total unique picks: 1123
- picks with at least two prices: 956
- average raw odds delta: 0.001475
- average implied-probability delta: 0.000474
- beat-later-price rate: 0.139121
...
- `2way-unanimous avg_p>=70`: n=226, two_prices=170, avg_raw=-0.001471, avg_ip=0.001083, beat_rate=0.170588
- `ml-meta avg_p>=55`: n=633, two_prices=579, avg_raw=-0.002556, avg_ip=0.001501, beat_rate=0.158895
- `ml-meta avg_p>=60`: n=131, two_prices=105, avg_raw=0.028571, avg_ip=-0.004933, beat_rate=0.057143
...
- `SKIPPED_VETO`: n=571, two_prices=520, avg_raw=-0.001885, avg_ip=0.001098, beat_rate=0.165385
...
- `WATCHLIST_UNCORROBORATED_PRICE`: n=228, two_prices=211, avg_raw=-0.002701, avg_ip=0.001144, beat_rate=0.056872
