...
- unmatched picks: 74
- picks with fewer than two snapshots: 106

## By rule

- `2way-unanimous avg_p>=70`: n=231, two_prices=170, avg_raw=-0.001471, avg_ip=0.001083, beat_rate=0.170588
- `ml-meta avg_p>=55`: n=640, two_prices=579, avg_raw=-0.002677, avg_ip=0.001529, beat_rate=0.160622
- `ml-meta avg_p>=60`: n=132, two_prices=105, avg_raw=0.028571, avg_ip=-0.004933, beat_rate=0.057143
...
- `CAUTION`: n=106, two_prices=95, avg_raw=0.003789, avg_ip=-0.000384, beat_rate=0.168421
- `CERTIFIED_CLEAN`: n=112, two_prices=97, avg_raw=0.026804, avg_ip=-0.003473, beat_rate=0.175258
- `SKIPPED_VETO`: n=578, two_prices=520, avg_raw=-0.001885, avg_ip=0.001098, beat_rate=0.165385
...
- `WATCHLIST_UNCORROBORATED_PRICE`: n=234, two_prices=211, avg_raw=-0.002701, avg_ip=0.001144, beat_rate=0.056872
