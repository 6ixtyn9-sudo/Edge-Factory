...
- average raw odds delta: 0.001426
- average implied-probability delta: 0.000433
- beat-later-price rate: 0.138524
...
- `ml-meta avg_p>=55`: n=666, two_prices=610, avg_raw=-0.002393, avg_ip=0.001364, beat_rate=0.155738
...
- `CAUTION`: n=108, two_prices=97, avg_raw=0.004227, avg_ip=-0.000496, beat_rate=0.164948
...
- `WATCHLIST_UNCORROBORATED_PRICE`: n=243, two_prices=221, avg_raw=-0.002308, avg_ip=0.000901, beat_rate=0.054299
