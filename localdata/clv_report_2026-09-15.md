...
- average raw odds delta: 0.002346
- average implied-probability delta: 0.000224
- beat-later-price rate: 0.148104
...
- `2way-unanimous avg_p>=70`: n=192, two_prices=151, avg_raw=-0.000728, avg_ip=0.000686, beat_rate=0.152318
- `ml-meta avg_p>=55`: n=575, two_prices=521, avg_raw=-0.002092, avg_ip=0.001314, beat_rate=0.170825
- `ml-meta avg_p>=60`: n=92, two_prices=74, avg_raw=0.042297, avg_ip=-0.007726, beat_rate=0.067568
...
- `CAUTION`: n=113, two_prices=102, avg_raw=0.005392, avg_ip=-0.001097, beat_rate=0.147059
- `CERTIFIED_CLEAN`: n=80, two_prices=66, avg_raw=0.045455, avg_ip=-0.00778, beat_rate=0.19697
- `SKIPPED_VETO`: n=497, two_prices=461, avg_raw=-0.002495, avg_ip=0.001431, beat_rate=0.184382
...
- `WATCHLIST_UNKNOWN_CTX`: n=13, two_prices=12, avg_raw=0.010833, avg_ip=-0.006779, beat_rate=0.0
