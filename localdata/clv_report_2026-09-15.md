...
- total unique picks: 993
- picks with at least two prices: 850
- average raw odds delta: 0.002071
- average implied-probability delta: 0.000279
- beat-later-price rate: 0.149412
- beat-later-price sample: 850
- unmatched picks: 67
- picks with fewer than two snapshots: 77
...
- `ml-meta avg_p>=60`: n=98, two_prices=79, avg_raw=0.04, avg_ip=-0.007457, beat_rate=0.063291
- `ml-meta avg_p>=65`: n=28, two_prices=16, avg_raw=-0.0075, avg_ip=0.00275, beat_rate=0.125
...
- `CAUTION`: n=115, two_prices=104, avg_raw=0.005577, avg_ip=-0.001243, beat_rate=0.144231
- `CERTIFIED_CLEAN`: n=82, two_prices=67, avg_raw=0.044776, avg_ip=-0.007664, beat_rate=0.19403
- `SKIPPED_VETO`: n=501, two_prices=463, avg_raw=-0.003002, avg_ip=0.001552, beat_rate=0.185745
