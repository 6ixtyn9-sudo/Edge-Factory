...
- picks with at least two prices: 280
- average raw odds delta: 0.003004
- average implied-probability delta: -0.001341
- beat-later-price rate: 0.15
- beat-later-price sample: 280
- unmatched picks: 16
...
- `2way-unanimous avg_p>=70`: n=103, two_prices=94, avg_raw=0.002277, avg_ip=-0.001621, beat_rate=0.138298
...
- `ml-meta avg_p>=55`: n=87, two_prices=80, avg_raw=0.008625, avg_ip=-0.002992, beat_rate=0.225
...
- `CAUTION`: n=59, two_prices=54, avg_raw=0.002593, avg_ip=-0.000212, beat_rate=0.12963
- `CERTIFIED_CLEAN`: n=22, two_prices=22, avg_raw=-0.001, avg_ip=0.0015, beat_rate=0.318182
- `SKIPPED_VETO`: n=165, two_prices=158, avg_raw=0.004703, avg_ip=-0.002417, beat_rate=0.151899
...
- `WATCHLIST_UNCORROBORATED_PRICE`: n=23, two_prices=23, avg_raw=-0.006957, avg_ip=0.003112, beat_rate=0.173913
