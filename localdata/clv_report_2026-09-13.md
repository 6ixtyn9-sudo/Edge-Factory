...
- total unique picks: 971
- picks with at least two prices: 837
- average raw odds delta: 0.003522
- average implied-probability delta: -0.000228
- beat-later-price rate: 0.143369
- beat-later-price sample: 837
- unmatched picks: 66
- picks with fewer than two snapshots: 68

## By rule

- `2way-unanimous avg_p>=70`: n=190, two_prices=150, avg_raw=-6.7e-05, avg_ip=0.000155, beat_rate=0.14
- `2way-unanimous min_p>=60 avg_p>=65`: n=11, two_prices=8, avg_raw=0.0, avg_ip=0.0, beat_rate=0.0
- `ml-meta avg_p>=55`: n=572, two_prices=523, avg_raw=-0.000554, avg_ip=0.000795, beat_rate=0.164436
- `ml-meta avg_p>=60`: n=73, two_prices=57, avg_raw=0.055439, avg_ip=-0.010406, beat_rate=0.070175
...
- `CERTIFIED_CLEAN`: n=81, two_prices=67, avg_raw=0.047582, avg_ip=-0.008276, beat_rate=0.19403
- `SKIPPED_VETO`: n=489, two_prices=455, avg_raw=-0.001604, avg_ip=0.000872, beat_rate=0.175824
...
- `WATCHLIST_UNCORROBORATED_PRICE`: n=183, two_prices=173, avg_raw=-0.000636, avg_ip=0.000593, beat_rate=0.046243
