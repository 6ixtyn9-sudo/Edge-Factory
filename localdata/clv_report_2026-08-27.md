...
- total unique picks: 472
- picks with at least two prices: 429
- average raw odds delta: 0.002823
- average implied-probability delta: -0.000942
- beat-later-price rate: 0.135198
...
- `ml-meta avg_p>=55`: n=186, two_prices=173, avg_raw=0.00474, avg_ip=-0.001214, beat_rate=0.16763
...
- `CAUTION`: n=78, two_prices=72, avg_raw=0.00625, avg_ip=-0.001383, beat_rate=0.111111
- `CERTIFIED_CLEAN`: n=22, two_prices=22, avg_raw=-0.001, avg_ip=0.0015, beat_rate=0.318182
- `SKIPPED_VETO`: n=261, two_prices=251, avg_raw=0.00292, avg_ip=-0.001302, beat_rate=0.151394
