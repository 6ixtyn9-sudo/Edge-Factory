...
- picks with at least two prices: 432
- average raw odds delta: 0.002919
- average implied-probability delta: -0.001029
- beat-later-price rate: 0.141204
- beat-later-price sample: 432
- unmatched picks: 23
...
- `ml-meta avg_p>=55`: n=190, two_prices=176, avg_raw=0.004943, avg_ip=-0.001423, beat_rate=0.181818
...
- `CAUTION`: n=79, two_prices=73, avg_raw=0.006301, avg_ip=-0.001438, beat_rate=0.109589
- `CERTIFIED_CLEAN`: n=23, two_prices=23, avg_raw=-0.000957, avg_ip=0.001434, beat_rate=0.304348
- `SKIPPED_VETO`: n=263, two_prices=252, avg_raw=0.003067, avg_ip=-0.001436, beat_rate=0.162698
