...
- total unique picks: 204
- picks with at least two prices: 184
- average raw odds delta: -0.001489
- average implied-probability delta: 0.000405
- beat-later-price rate: 0.119565
...
- `2way-unanimous avg_p>=70`: n=87, two_prices=77, avg_raw=-0.001078, avg_ip=0.000413, beat_rate=0.12987
...
- `ml-meta avg_p>=55`: n=15, two_prices=12, avg_raw=-0.005, avg_ip=0.000909, beat_rate=0.333333
...
- `CAUTION`: n=27, two_prices=25, avg_raw=-0.002, avg_ip=0.002057, beat_rate=0.08
- `CERTIFIED_CLEAN`: n=14, two_prices=14, avg_raw=-0.023571, avg_ip=0.008457, beat_rate=0.428571
- `SKIPPED_VETO`: n=124, two_prices=114, avg_raw=0.001456, avg_ip=-0.001036, beat_rate=0.096491
