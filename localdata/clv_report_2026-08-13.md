...
- average raw odds delta: 0.000119
- average implied-probability delta: -0.000333
...
- `2way-unanimous avg_p>=70`: n=87, two_prices=81, avg_raw=4.9e-05, avg_ip=-0.000258, beat_rate=0.135802
...
- `ml-meta avg_p>=55`: n=19, two_prices=18, avg_raw=0.008333, avg_ip=-0.004201, beat_rate=0.222222
...
- `CAUTION`: n=28, two_prices=27, avg_raw=-0.0, avg_ip=0.001215, beat_rate=0.074074
- `CERTIFIED_CLEAN`: n=15, two_prices=15, avg_raw=-0.022, avg_ip=0.007893, beat_rate=0.4
- `SKIPPED_VETO`: n=125, two_prices=119, avg_raw=0.003471, avg_ip=-0.002006, beat_rate=0.10084
