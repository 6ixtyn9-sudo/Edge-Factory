...
- picks with at least two prices: 355
- average raw odds delta: 0.002904
- average implied-probability delta: -0.001218
- beat-later-price rate: 0.138028
- beat-later-price sample: 355
- unmatched picks: 22
...
- `ml-meta avg_p>=55`: n=150, two_prices=137, avg_raw=0.004964, avg_ip=-0.001672, beat_rate=0.167883
- `ml-meta avg_p>=60`: n=11, two_prices=9, avg_raw=0.020444, avg_ip=-0.009207, beat_rate=0.0
- `ml-meta avg_p>=65`: n=8, two_prices=3, avg_raw=-0.004, avg_ip=0.006111, beat_rate=0.666667
- `ml-meta avg_p>=70`: n=9, two_prices=7, avg_raw=0.021429, avg_ip=-0.008501, beat_rate=0.0
...
- `SKIPPED_VETO`: n=209, two_prices=199, avg_raw=0.004236, avg_ip=-0.002397, beat_rate=0.145729
