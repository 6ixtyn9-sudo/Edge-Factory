...
- total unique picks: 952
- picks with at least two prices: 820
- average raw odds delta: 0.004055
- average implied-probability delta: -0.000442
- beat-later-price rate: 0.152439
- beat-later-price sample: 820
- unmatched picks: 63
- picks with fewer than two snapshots: 69

## By rule

- `2way-unanimous avg_p>=70`: n=192, two_prices=153, avg_raw=0.000569, avg_ip=-0.000184, beat_rate=0.150327
- `2way-unanimous min_p>=60 avg_p>=65`: n=11, two_prices=8, avg_raw=0.0, avg_ip=0.0, beat_rate=0.0
- `ml-meta avg_p>=55`: n=554, two_prices=506, avg_raw=-2e-05, avg_ip=0.000583, beat_rate=0.175889
...
- `CERTIFIED_CLEAN`: n=79, two_prices=65, avg_raw=0.049046, avg_ip=-0.008531, beat_rate=0.2
- `SKIPPED_VETO`: n=479, two_prices=445, avg_raw=-0.000838, avg_ip=0.000493, beat_rate=0.186517
