...
- unmatched picks: 62
- picks with fewer than two snapshots: 72

## By rule

- `2way-unanimous avg_p>=70`: n=190, two_prices=150, avg_raw=0.000113, avg_ip=1.9e-05, beat_rate=0.153333
- `2way-unanimous min_p>=60 avg_p>=65`: n=11, two_prices=8, avg_raw=0.0, avg_ip=0.0, beat_rate=0.0
- `ml-meta avg_p>=55`: n=546, two_prices=500, avg_raw=-0.00052, avg_ip=0.000803, beat_rate=0.178
...
- `CAUTION`: n=123, two_prices=110, avg_raw=0.005455, avg_ip=-0.000936, beat_rate=0.163636
...
- `WATCHLIST_UNCORROBORATED_PRICE`: n=176, two_prices=166, avg_raw=-0.001084, avg_ip=0.000797, beat_rate=0.054217
