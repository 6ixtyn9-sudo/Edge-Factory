...
- unmatched picks: 60
- picks with fewer than two snapshots: 61

## By rule

- `2way-unanimous avg_p>=70`: n=186, two_prices=150, avg_raw=0.000113, avg_ip=1.9e-05, beat_rate=0.153333
- `2way-unanimous min_p>=60 avg_p>=65`: n=11, two_prices=8, avg_raw=0.0, avg_ip=0.0, beat_rate=0.0
- `ml-meta avg_p>=55`: n=541, two_prices=500, avg_raw=-0.00052, avg_ip=0.000803, beat_rate=0.178
...
- `SKIPPED_VETO`: n=472, two_prices=440, avg_raw=-0.001348, avg_ip=0.000705, beat_rate=0.188636
- `WATCHLIST_NO_ODDS`: n=49, two_prices=0, avg_raw=None, avg_ip=None, beat_rate=None
