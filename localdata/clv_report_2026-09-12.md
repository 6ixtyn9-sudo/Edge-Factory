...
- unmatched picks: 61
- picks with fewer than two snapshots: 64

## By rule

- `2way-unanimous avg_p>=70`: n=188, two_prices=150, avg_raw=0.000113, avg_ip=1.9e-05, beat_rate=0.153333
- `2way-unanimous min_p>=60 avg_p>=65`: n=11, two_prices=8, avg_raw=0.0, avg_ip=0.0, beat_rate=0.0
- `ml-meta avg_p>=55`: n=542, two_prices=500, avg_raw=-0.00052, avg_ip=0.000803, beat_rate=0.178
- `ml-meta avg_p>=60`: n=71, two_prices=55, avg_raw=0.057455, avg_ip=-0.010784, beat_rate=0.072727
...
- `CAUTION`: n=121, two_prices=110, avg_raw=0.005455, avg_ip=-0.000936, beat_rate=0.163636
- `CERTIFIED_CLEAN`: n=73, two_prices=62, avg_raw=0.051419, avg_ip=-0.008944, beat_rate=0.209677
- `SKIPPED_VETO`: n=473, two_prices=440, avg_raw=-0.001348, avg_ip=0.000705, beat_rate=0.188636
- `WATCHLIST_NO_ODDS`: n=50, two_prices=0, avg_raw=None, avg_ip=None, beat_rate=None
