...
- total unique picks: 191
- picks with at least two prices: 175
- average raw odds delta: -0.001303
- average implied-probability delta: 0.000363
- beat-later-price rate: 0.114286
- beat-later-price sample: 175
- unmatched picks: 6
...
- `2way-unanimous avg_p>=70`: n=82, two_prices=74, avg_raw=-0.001122, avg_ip=0.00043, beat_rate=0.135135
...
- `ml-meta avg_p>=55`: n=7, two_prices=6, avg_raw=-0.001667, avg_ip=-0.000344, beat_rate=0.333333
...
- `SKIPPED_VETO`: n=114, two_prices=108, avg_raw=0.002148, avg_ip=-0.001178, beat_rate=0.083333
...
- `WATCHLIST_UNCORROBORATED_PRICE`: n=11, two_prices=10, avg_raw=-0.004, avg_ip=0.001977, beat_rate=0.2
- `WATCHLIST_UNKNOWN_CTX`: n=19, two_prices=17, avg_raw=0.001765, avg_ip=-0.001121, beat_rate=0.0
