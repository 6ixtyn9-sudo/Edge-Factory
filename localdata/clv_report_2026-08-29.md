...
- `2way-unanimous avg_p>=70`: n=145, two_prices=131, avg_raw=0.001328, avg_ip=-0.00072, beat_rate=0.129771
- `2way-unanimous min_p>=60 avg_p>=65`: n=11, two_prices=8, avg_raw=0.0, avg_ip=0.0, beat_rate=0.0
- `3way-unanimous avg_p>=65`: n=40, two_prices=38, avg_raw=0.005658, avg_ip=-0.003196, beat_rate=0.026316
- `ml-meta avg_p>=55`: n=237, two_prices=221, avg_raw=0.003937, avg_ip=-0.000864, beat_rate=0.158371
- `ml-meta avg_p>=60`: n=41, two_prices=37, avg_raw=0.006865, avg_ip=-0.003023, beat_rate=0.027027
...
- `CERTIFIED_CLEAN`: n=34, two_prices=33, avg_raw=0.003879, avg_ip=-0.000548, beat_rate=0.212121
- `SKIPPED_VETO`: n=294, two_prices=284, avg_raw=0.001982, avg_ip=-0.000754, beat_rate=0.15493
