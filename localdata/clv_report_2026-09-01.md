...
- total unique picks: 652
- picks with at least two prices: 585
- average raw odds delta: 0.005583
- average implied-probability delta: -0.000686
- beat-later-price rate: 0.152137
- beat-later-price sample: 585
- unmatched picks: 38
...
- `2way-unanimous avg_p>=70`: n=171, two_prices=151, avg_raw=0.000556, avg_ip=-0.000363, beat_rate=0.139073
- `2way-unanimous min_p>=60 avg_p>=65`: n=11, two_prices=8, avg_raw=0.0, avg_ip=0.0, beat_rate=0.0
- `3way-unanimous avg_p>=65`: n=27, two_prices=26, avg_raw=-0.001154, avg_ip=-0.000109, beat_rate=0.038462
- `ml-meta avg_p>=55`: n=309, two_prices=287, avg_raw=0.000767, avg_ip=0.000576, beat_rate=0.191638
...
- `CAUTION`: n=101, two_prices=93, avg_raw=0.007419, avg_ip=-0.001731, beat_rate=0.139785
- `CERTIFIED_CLEAN`: n=46, two_prices=44, avg_raw=0.064045, avg_ip=-0.009948, beat_rate=0.227273
- `SKIPPED_VETO`: n=343, two_prices=329, avg_raw=-0.000644, avg_ip=0.000483, beat_rate=0.176292
...
- `WATCHLIST_UNCORROBORATED_PRICE`: n=97, two_prices=92, avg_raw=-0.001196, avg_ip=0.000883, beat_rate=0.076087
