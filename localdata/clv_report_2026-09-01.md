...
- picks with at least two prices: 578
- average raw odds delta: 0.005218
- average implied-probability delta: -0.000571
- beat-later-price rate: 0.153979
- beat-later-price sample: 578
- unmatched picks: 38
- picks with fewer than two snapshots: 35

## By rule

- `2way+bc-confirms avg_p>=60`: n=35, two_prices=33, avg_raw=-0.010909, avg_ip=0.004892, beat_rate=0.212121
- `2way-unanimous avg_p>=70`: n=171, two_prices=148, avg_raw=0.000568, avg_ip=-0.00037, beat_rate=0.141892
- `2way-unanimous min_p>=60 avg_p>=65`: n=11, two_prices=8, avg_raw=0.0, avg_ip=0.0, beat_rate=0.0
- `3way-unanimous avg_p>=65`: n=27, two_prices=26, avg_raw=-0.001154, avg_ip=-0.000109, beat_rate=0.038462
- `ml-meta avg_p>=55`: n=308, two_prices=283, avg_raw=-0.000106, avg_ip=0.000836, beat_rate=0.194346
...
- `SKIPPED_VETO`: n=342, two_prices=323, avg_raw=-0.000563, avg_ip=0.000476, beat_rate=0.179567
