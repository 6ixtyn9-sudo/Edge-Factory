...
- total unique picks: 638
- picks with at least two prices: 571
- average raw odds delta: 0.005089
- average implied-probability delta: -0.000515
...
- `ml-meta avg_p>=55`: n=299, two_prices=277, avg_raw=-0.000253, avg_ip=0.000849, beat_rate=0.194946
...
- `CAUTION`: n=99, two_prices=91, avg_raw=0.003626, avg_ip=-0.000482, beat_rate=0.142857
- `CERTIFIED_CLEAN`: n=45, two_prices=43, avg_raw=0.065535, avg_ip=-0.01018, beat_rate=0.232558
- `SKIPPED_VETO`: n=333, two_prices=319, avg_raw=-0.000665, avg_ip=0.000467, beat_rate=0.178683
