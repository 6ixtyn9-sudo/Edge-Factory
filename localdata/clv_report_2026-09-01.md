...
- `2way-unanimous avg_p>=70`: n=168, two_prices=148, avg_raw=0.000568, avg_ip=-0.00037, beat_rate=0.141892
- `2way-unanimous min_p>=60 avg_p>=65`: n=11, two_prices=8, avg_raw=0.0, avg_ip=0.0, beat_rate=0.0
- `3way-unanimous avg_p>=65`: n=27, two_prices=26, avg_raw=-0.001154, avg_ip=-0.000109, beat_rate=0.038462
- `ml-meta avg_p>=55`: n=306, two_prices=283, avg_raw=-0.000106, avg_ip=0.000836, beat_rate=0.194346
...
- `SKIPPED_VETO`: n=338, two_prices=323, avg_raw=-0.000563, avg_ip=0.000476, beat_rate=0.179567
