...
- picks with at least two prices: 105
- average raw odds delta: 0.007
- average implied-probability delta: -0.002984
- beat-later-price rate: 0.019048
- beat-later-price sample: 105
- unmatched picks: 2
...
- `3way-unanimous avg_p>=65`: n=29, two_prices=25, avg_raw=0.0102, avg_ip=-0.004994, beat_rate=0.0
...
- `CAUTION`: n=19, two_prices=17, avg_raw=0.0, avg_ip=0.0, beat_rate=0.0
- `SKIPPED_VETO`: n=81, two_prices=75, avg_raw=0.0094, avg_ip=-0.003924, beat_rate=0.026667
- `WATCHLIST_NO_ODDS`: n=2, two_prices=0, avg_raw=None, avg_ip=None, beat_rate=None
- `WATCHLIST_UNKNOWN_CTX`: n=14, two_prices=13, avg_raw=0.002308, avg_ip=-0.001465, beat_rate=0.0
