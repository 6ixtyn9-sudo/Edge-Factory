...
- unmatched picks: 70
- picks with fewer than two snapshots: 97

## By rule

- `2way-unanimous avg_p>=70`: n=207, two_prices=155, avg_raw=-0.001484, avg_ip=0.001127, beat_rate=0.180645
- `ml-meta avg_p>=55`: n=589, two_prices=531, avg_raw=-0.003107, avg_ip=0.001695, beat_rate=0.167608
- `ml-meta avg_p>=60`: n=107, two_prices=84, avg_raw=0.035952, avg_ip=-0.006287, beat_rate=0.071429
...
- `CAUTION`: n=106, two_prices=95, avg_raw=0.004737, avg_ip=-0.000659, beat_rate=0.157895
- `CERTIFIED_CLEAN`: n=96, two_prices=78, avg_raw=0.034487, avg_ip=-0.004734, beat_rate=0.192308
- `SKIPPED_VETO`: n=526, two_prices=477, avg_raw=-0.002558, avg_ip=0.001309, beat_rate=0.176101
...
- `WATCHLIST_UNCORROBORATED_PRICE`: n=208, two_prices=190, avg_raw=-0.003, avg_ip=0.001271, beat_rate=0.063158
