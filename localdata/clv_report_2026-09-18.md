...
- average raw odds delta: 0.001619
- average implied-probability delta: 0.000486
...
- `2way-unanimous avg_p>=70`: n=209, two_prices=158, avg_raw=-0.001329, avg_ip=0.000993, beat_rate=0.170886
- `ml-meta avg_p>=55`: n=592, two_prices=539, avg_raw=-0.00282, avg_ip=0.001637, beat_rate=0.166976
...
- `CERTIFIED_CLEAN`: n=96, two_prices=81, avg_raw=0.034444, avg_ip=-0.005004, beat_rate=0.185185
- `SKIPPED_VETO`: n=529, two_prices=483, avg_raw=-0.002422, avg_ip=0.001294, beat_rate=0.173913
- `WATCHLIST_NO_ODDS`: n=59, two_prices=1, avg_raw=0.0, avg_ip=0.0, beat_rate=0.0
