...
- total unique picks: 1022
- picks with at least two prices: 870
- average raw odds delta: 0.001483
- average implied-probability delta: 0.000524
- beat-later-price rate: 0.147126
- beat-later-price sample: 870
- unmatched picks: 68
- picks with fewer than two snapshots: 84

## By rule

- `2way-unanimous avg_p>=70`: n=203, two_prices=155, avg_raw=-0.001419, avg_ip=0.001069, beat_rate=0.174194
- `ml-meta avg_p>=55`: n=584, two_prices=531, avg_raw=-0.003107, avg_ip=0.001695, beat_rate=0.167608
...
- `CERTIFIED_CLEAN`: n=93, two_prices=78, avg_raw=0.034487, avg_ip=-0.004734, beat_rate=0.192308
- `SKIPPED_VETO`: n=521, two_prices=477, avg_raw=-0.002537, avg_ip=0.00129, beat_rate=0.174004
- `WATCHLIST_NO_ODDS`: n=56, two_prices=0, avg_raw=None, avg_ip=None, beat_rate=None
- `WATCHLIST_SUSPECT_PRICE`: n=27, two_prices=18, avg_raw=-0.004444, avg_ip=0.002071, beat_rate=0.111111
- `WATCHLIST_UNCORROBORATED_PRICE`: n=206, two_prices=190, avg_raw=-0.003, avg_ip=0.001271, beat_rate=0.063158
