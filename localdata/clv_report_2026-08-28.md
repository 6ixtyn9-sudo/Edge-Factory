...
- picks with at least two prices: 460
- average raw odds delta: 0.002676
- average implied-probability delta: -0.000794
- beat-later-price rate: 0.13913
- beat-later-price sample: 460
- unmatched picks: 23
...
- `ml-meta avg_p>=55`: n=211, two_prices=196, avg_raw=0.004337, avg_ip=-0.000932, beat_rate=0.173469
...
- `CAUTION`: n=81, two_prices=75, avg_raw=0.0064, avg_ip=-0.001542, beat_rate=0.106667
- `CERTIFIED_CLEAN`: n=29, two_prices=28, avg_raw=0.004571, avg_ip=-0.000645, beat_rate=0.25
- `SKIPPED_VETO`: n=279, two_prices=269, avg_raw=0.00213, avg_ip=-0.00082, beat_rate=0.163569
...
- `WATCHLIST_UNCORROBORATED_PRICE`: n=62, two_prices=58, avg_raw=-0.001034, avg_ip=0.000878, beat_rate=0.068966
