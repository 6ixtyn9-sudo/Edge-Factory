...
- picks with at least two prices: 428
- average raw odds delta: 0.002829
- average implied-probability delta: -0.000944
- beat-later-price rate: 0.135514
- beat-later-price sample: 428
- unmatched picks: 23
...
- `ml-meta avg_p>=55`: n=181, two_prices=168, avg_raw=0.004881, avg_ip=-0.00125, beat_rate=0.172619
...
- `CAUTION`: n=80, two_prices=74, avg_raw=0.006081, avg_ip=-0.001346, beat_rate=0.108108
- `CERTIFIED_CLEAN`: n=22, two_prices=22, avg_raw=-0.001, avg_ip=0.0015, beat_rate=0.318182
- `SKIPPED_VETO`: n=258, two_prices=248, avg_raw=0.002956, avg_ip=-0.001317, beat_rate=0.153226
