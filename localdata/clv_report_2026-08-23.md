...
- total unique picks: 427
- picks with at least two prices: 386
- average raw odds delta: 0.002386
- average implied-probability delta: -0.001
- beat-later-price rate: 0.137306
- beat-later-price sample: 386
- unmatched picks: 22
...
- `ml-meta avg_p>=60`: n=28, two_prices=25, avg_raw=0.00616, avg_ip=-0.00277, beat_rate=0.04
...
- `SKIPPED_VETO`: n=229, two_prices=219, avg_raw=0.003119, avg_ip=-0.001857, beat_rate=0.150685
...
- `WATCHLIST_UNCORROBORATED_PRICE`: n=52, two_prices=49, avg_raw=-0.001224, avg_ip=0.001039, beat_rate=0.081633
