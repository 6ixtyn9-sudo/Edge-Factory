...
- picks with at least two prices: 393
- average raw odds delta: 0.002598
- average implied-probability delta: -0.001095
- beat-later-price rate: 0.132316
- beat-later-price sample: 393
- unmatched picks: 22
...
- `CAUTION`: n=73, two_prices=68, avg_raw=0.003529, avg_ip=-0.000199, beat_rate=0.117647
- `CERTIFIED_CLEAN`: n=22, two_prices=22, avg_raw=-0.001, avg_ip=0.0015, beat_rate=0.318182
- `SKIPPED_VETO`: n=232, two_prices=223, avg_raw=0.003377, avg_ip=-0.001969, beat_rate=0.143498
...
- `WATCHLIST_UNCORROBORATED_PRICE`: n=53, two_prices=50, avg_raw=-0.0012, avg_ip=0.001018, beat_rate=0.08
