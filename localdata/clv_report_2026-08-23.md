...
- total unique picks: 420
- picks with at least two prices: 383
- average raw odds delta: 0.002457
- average implied-probability delta: -0.001017
- beat-later-price rate: 0.133159
...
- `2way-unanimous avg_p>=70`: n=126, two_prices=115, avg_raw=0.001687, avg_ip=-0.001167, beat_rate=0.130435
...
- `ml-meta avg_p>=60`: n=25, two_prices=23, avg_raw=0.008, avg_ip=-0.003603, beat_rate=0.0
- `ml-meta avg_p>=65`: n=8, two_prices=4, avg_raw=-0.003, avg_ip=0.004583, beat_rate=0.5
- `ml-meta avg_p>=70`: n=11, two_prices=10, avg_raw=0.015, avg_ip=-0.00595, beat_rate=0.0
- `ml-meta avg_p>=75`: n=4, two_prices=4, avg_raw=-0.0075, avg_ip=0.005253, beat_rate=0.25
- `ml-meta avg_p>=80`: n=1, two_prices=1, avg_raw=0.0, avg_ip=0.0, beat_rate=0.0
...
- `SKIPPED_VETO`: n=223, two_prices=216, avg_raw=0.003255, avg_ip=-0.001898, beat_rate=0.143519
