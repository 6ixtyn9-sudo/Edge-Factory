# Edge Factory — Recent picks audit (2026-07-23 to 2026-08-21)

## Overall

- archived pick rows: 324
- archived pick dates: 30
- immutable morning-baseline rows: 180
- verified official late-slate additions: 26
- regular-ledger-only legacy rows: 118
- unsafe regular ledgers ignored: 6
- empty regular ledgers (morning-baseline coverage only): 0
- settled picks: 289
- eligible prior 1x2 picks: 299
...
- same-day cutoff date: 2026-08-21
- same-day rows excluded: 25

## Secondary Market Realized Rates

Metrics scored against actual outcomes of the settled consensus picks in this window:
- **Over 2.5 Goals**: occurred in 187 / 289 matches (64.7%)
- **Both Teams to Score (BTTS)**: occurred in 157 / 289 matches (54.3%)
- **Selected Team Over 1.5 Goals**: occurred in 201 / 289 matches (69.6%)

## Recommended Enhancements Audit

Performance of deep context-derived recommended enhancements overlay:
- **Total Recommended Enhancements**: 259
- **Total Hits**: 208
- **Overall Hit Rate**: 80.3%
...
- `match_over_25`: recommended=61, hits=43, hit_rate=70.5%
...
- notes on settled picks: **1671** | scored: 1671

### Per-market hit table

| market | notes | n | hits | realized | promised avg | Δ | Brier |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `away_under_35` | 207 | 207 | 204 | 98.6% | 97.8% | +0.7% | 0.013883 |
| `away_under_25` | 193 | 193 | 181 | 93.8% | 93.7% | +0.1% | 0.059298 |
| `match_over_25` | 190 | 190 | 121 | 63.7% | 43.5% | +20.2% | 0.276419 |
| `home_over_05` | 189 | 189 | 175 | 92.6% | 87.5% | +5.1% | 0.071955 |
| `match_over_45` | 168 | 168 | 43 | 25.6% | 25.0% | +0.6% | 0.193859 |
...
| `home_under_35` | 50 | 50 | 46 | 92.0% | 94.4% | -2.4% | 0.073281 |
| `btts_no` | 40 | 40 | 17 | 42.5% | 52.7% | -10.2% | 0.252916 |
| `btts_yes` | 38 | 38 | 19 | 50.0% | 50.9% | -0.9% | 0.248905 |
| `home_under_25` | 38 | 38 | 35 | 92.1% | 91.4% | +0.7% | 0.073619 |
...
| --- | --- | --- | --- | --- | --- | --- |
| hybrid_cohort | 1355 | 891 | 65.8% | 63.2% | +2.5% | 0.133734 |
...
| --- | --- | --- | --- | --- |
| 0.1-0.2 | 156 | 15.9% | 19.9% | +3.9% |
| 0.2-0.3 | 211 | 24.8% | 24.2% | -0.6% |
| 0.3-0.4 | 221 | 35.6% | 45.2% | +9.6% |
| 0.4-0.5 | 186 | 44.8% | 49.5% | +4.6% |
| 0.5-0.6 | 97 | 52.6% | 48.5% | -4.1% |
| 0.6-0.7 | 5 | 65.3% | 100.0% | +34.7% |
| 0.7-0.8 | 4 | 74.4% | 50.0% | -24.4% |
| 0.8-0.9 | 265 | 84.4% | 87.9% | +3.5% |
| 0.9-1.0 | 526 | 95.3% | 95.6% | +0.3% |
...
- **Avg Goals forecast**: n=258, MAE=1.45124 goals, bias=-0.349767 (realized − promised), promised avg 3.621085 vs realized 3.271318

### Per-metric calibration

| metric | n | promised avg | realized | Δ | Brier |
| --- | --- | --- | --- | --- | --- |
| Away Over 1.5 | 258 | 23.1% | 30.2% | +7.2% | 0.194366 |
| BTTS-Yes | 258 | 41.5% | 54.3% | +12.8% | 0.264846 |
| Home Over 1.5 | 258 | 72.6% | 60.1% | -12.5% | 0.222794 |
| Over 2.5 | 258 | 71.1% | 64.0% | -7.2% | 0.233366 |

### Promised-vs-realized calibration (all 📊 metrics pooled)

| promised bucket | n | promised avg | realized | Δ |
| --- | --- | --- | --- | --- |
| 0.0-0.1 | 182 | 8.9% | 18.7% | +9.8% |
| 0.1-0.2 | 77 | 10.4% | 27.3% | +16.9% |
| 0.3-0.4 | 66 | 37.8% | 54.5% | +16.7% |
| 0.4-0.5 | 191 | 42.9% | 53.9% | +11.1% |
| 0.6-0.7 | 132 | 66.9% | 58.3% | -8.5% |
| 0.7-0.8 | 116 | 74.8% | 69.0% | -5.8% |
| 0.8-0.9 | 223 | 85.1% | 68.2% | -16.9% |
| 0.9-1.0 | 45 | 91.9% | 77.8% | -14.2% |

## By rule

- `2way+bc-confirms avg_p>=60`: settled=33, wins=19, hit_rate=0.575758, ROI=-0.213548
- `2way-unanimous avg_p>=70`: settled=99, wins=79, hit_rate=0.79798, ROI=0.076256
...
- `ml-meta avg_p>=55`: settled=88, wins=53, hit_rate=0.602273, ROI=-0.066548
...
- `CAUTION`: settled=67, wins=39, hit_rate=0.58209, ROI=-0.070299
- `CERTIFIED_CLEAN`: settled=21, wins=9, hit_rate=0.428571, ROI=-0.375714
- `SKIPPED_VETO`: settled=138, wins=104, hit_rate=0.753623, ROI=0.039261
...
- `WATCHLIST_UNCORROBORATED_PRICE`: settled=25, wins=18, hit_rate=0.72, ROI=0.042
- `WATCHLIST_UNKNOWN_CTX`: settled=17, wins=15, hit_rate=0.882353, ROI=0.072941

## By odds source

- `UNKNOWN`: settled=18, wins=15, hit_rate=0.833333, ROI=None
- `betexplorer_odds`: settled=102, wins=74, hit_rate=0.72549, ROI=0.031667
- `bzzoiro_odds`: settled=91, wins=60, hit_rate=0.659341, ROI=-0.043319
- `forebet_best`: settled=9, wins=6, hit_rate=0.666667, ROI=-0.095556
- `scoutingstats_odds`: settled=58, wins=36, hit_rate=0.62069, ROI=-0.130862
- `zulubet`: settled=11, wins=11, hit_rate=1.0, ROI=0.345455

## By odds match method

- `alias_fuzzy`: settled=16, wins=11, hit_rate=0.6875, ROI=-0.07
- `betexplorer`: settled=102, wins=74, hit_rate=0.72549, ROI=0.031667
- `exact`: settled=141, wins=91, hit_rate=0.64539, ROI=-0.068738
...
| --- | --- | --- | --- | --- | --- |
| BetExplorer rescue (`BETEXPLORER_RESCUE`) | 102 | 74 | 0.72549 | 102 | 0.031667 |
| Bzzoiro primary match (`BZZOIRO_PRIMARY`) | 83 | 55 | 0.662651 | 83 | -0.025325 |
| ScoutingStats sole fallback (`SCOUTINGSTATS_SOLE`) | 58 | 36 | 0.62069 | 58 | -0.130862 |
...
| --- | --- | --- | --- | --- | --- |
| **overall (SKIPPED_VETO)** | 138 | 104 | 0.753623 | 138 | 0.039261 |
| **trusted evidence only** | 99 | 75 | 0.757576 | 99 | 0.054424 |
| **soft evidence only** | 39 | 29 | 0.74359 | 39 | 0.000769 |
| evidence: BETEXPLORER_RESCUE | 49 | 40 | 0.816327 | 49 | 0.114286 |
| evidence: BZZOIRO_PRIMARY | 50 | 35 | 0.7 | 50 | -0.00424 |
...
| odds band: <1.50 | 102 | 82 | 0.803922 | 102 | 0.044294 |
| odds band: 1.50-2.00 | 35 | 21 | 0.6 | 35 | -0.002857 |
...
| veto reason: context VETO in ['odds_band'] | 41 | 34 | 0.829268 | 41 | 0.129512 |
...
| veto reason: context VETO in ['team_h'] | 30 | 20 | 0.666667 | 30 | -0.052833 |
...
| contrast CAUTION: BETEXPLORER_RESCUE | 33 | 21 | 0.636364 | 33 | 0.018485 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| No price quarantine (`NONE`) | 215 | 155 | 0.72093 | 198 | 0.016556 | 0 | None |
| alias_fuzzy match (`alias_fuzzy`) | 16 | 11 | 0.6875 | 15 | -0.07 | 8 | 1.359375 |
| ScoutingStats sole source (`scoutingstats_sole_source`) | 58 | 36 | 0.62069 | 58 | -0.130862 | 0 | None |
## Settled Picks Granular Expectations Audit

Visual audit of expected historical stats (from the `📊` line) against actual realized scores:

### 2026-08-20: Motherwell vs SC Freiburg (Actual Score: **1-3**)
- **1X2 Pick**: Selected `AWAY` @ 1.5 -> 🟢 WON (Expected prob: 59.3%)
  - [🟢 HIT] **Over 2.5 Goals**: expected 69.5% (Actual: 4 goals)
  ...
  - **🔥 Possible Events (graded)**:
    - [🟢 HIT] **Match Over 2.5 Goals**: expected 52.9% (Actual: 4 goals)
...
### 2026-08-20: FC Midtjylland vs HNK Rijeka (Actual Score: **2-0**)
- **1X2 Pick**: Selected `HOME` @ 1.65 -> 🟢 WON (Expected prob: 57.4%)
...
### 2026-08-20: FK Neftekhimik vs FC Sochi (Actual Score: **1-2**)
- **1X2 Pick**: Selected `AWAY` @ 1.87 -> 🟢 WON (Expected prob: 55.7%)
  ...
  - **🔥 Possible Events (graded)**:
    ...
    - [🟢 HIT] **Home Team Under 3.5 Goals**: expected 95.1% (Actual: 1 home goals)
    - [🟢 HIT] **Home Team Under 2.5 Goals**: expected 91.1% (Actual: 1 home goals)
    - [🔴 MISS] **Match Over 4.5 Goals**: expected 18.2% (Actual: 3 goals)

### 2026-08-20: Vancouver Whitecaps vs Houston Dynamo (Actual Score: **0-1**)
- **1X2 Pick**: Selected `HOME` @ 1.57 -> 🔴 LOST (Expected prob: 57.7%)
  - [🔴 MISS] **Over 2.5 Goals**: expected 65.9% (Actual: 1 goals)
  - [🟢 HIT] **BTTS-No**: expected 44.6% (Actual: BTTS-No)
  ...
  - **🔥 Possible Events (graded)**:
    ...
    - [🟢 HIT] **Away Team Under 2.5 Goals**: expected 93.0% (Actual: 1 away goals)

### 2026-08-20: Getafe vs FK Partizan (Actual Score: **3-1**)
- **1X2 Pick**: Selected `HOME` @ 1.4 -> 🟢 WON (Expected prob: 77.5%)
  - [🟢 HIT] **Over 2.5 Goals**: expected 79.6% (Actual: 4 goals)
  - [🔴 MISS] **BTTS-No**: expected 42.2% (Actual: BTTS-Yes)
  - [🟢 HIT] **Home Team Over 1.5 Goals**: expected 91.7% (Actual: 3 goals)
  - [🟢 HIT] **Away Team Under 1.5 Goals**: expected 91.3% (Actual: 1 goals)
  - **🔥 Possible Events (graded)**:
    - [🟢 HIT] **Match Over 2.5 Goals**: expected 57.0% (Actual: 4 goals)
    - [🟢 HIT] **Home Team Over 0.5 Goals**: expected 85.0% (Actual: 3 home goals)
...
### 2026-08-20: Seattle Sounders vs Austin FC (Actual Score: **1-2**)
- **1X2 Pick**: Selected `HOME` @ 1.55 -> 🔴 LOST (Expected prob: 57.0%)
...
### 2026-08-20: LDU Quito vs Mirassol (Actual Score: **0-0**)
- **1X2 Pick**: Selected `HOME` @ 1.57 -> 🔴 LOST (Expected prob: 78.7%)
  - [🔴 MISS] **Over 2.5 Goals**: expected 76.2% (Actual: 0 goals)
  ...
  - **🔥 Possible Events (graded)**:
    ...
    - [🔴 MISS] **Home Team Over 0.5 Goals**: expected 82.0% (Actual: 0 home goals)
    - [🟢 HIT] **Away Team Under 3.5 Goals**: expected 92.7% (Actual: 0 away goals)

### 2026-08-20: Lech Poznan vs FC Thun (Actual Score: **7-0**)
- **1X2 Pick**: Selected `HOME` @ 1.5 -> 🟢 WON (Expected prob: 57.8%)
  - [🟢 HIT] **Over 2.5 Goals**: expected 65.9% (Actual: 7 goals)
  - [🟢 HIT] **BTTS-No**: expected 44.6% (Actual: BTTS-No)
  - [🟢 HIT] **Home Team Over 1.5 Goals**: expected 82.3% (Actual: 7 goals)
  - [🟢 HIT] **Away Team Under 1.5 Goals**: expected 90.2% (Actual: 0 goals)
  - **🔥 Possible Events (graded)**:
    - [🟢 HIT] **Match Over 2.5 Goals**: expected 49.5% (Actual: 7 goals)
    - [🟢 HIT] **Home Team Over 0.5 Goals**: expected 83.7% (Actual: 7 home goals)
...
### 2026-08-20: PAOK vs Brann (Actual Score: **1-1**)
- **1X2 Pick**: Selected `HOME` @ 1.66 -> 🔴 LOST (Expected prob: 56.9%)
  ...
  - **🔥 Possible Events (graded)**:
    - [🔴 MISS] **Match Over 2.5 Goals**: expected 49.1% (Actual: 2 goals)
