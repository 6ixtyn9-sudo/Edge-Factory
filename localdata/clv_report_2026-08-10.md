...
- average raw odds delta: 0.000488
- average implied-probability delta: -0.000444
- beat-later-price rate: 0.067901
...
- `2way+bc-confirms avg_p>=60`: n=25, two_prices=23, avg_raw=-0.003913, avg_ip=0.001647, beat_rate=0.086957
...
- `CERTIFIED_CLEAN`: n=8, two_prices=8, avg_raw=-0.01125, avg_ip=0.004736, beat_rate=0.25
