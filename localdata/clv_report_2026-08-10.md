...
- average implied-probability delta: -0.000239
- beat-later-price rate: 0.084848
...
- `2way+bc-confirms avg_p>=60`: n=27, two_prices=25, avg_raw=-0.0068, avg_ip=0.002816, beat_rate=0.2
- `2way-unanimous avg_p>=70`: n=80, two_prices=75, avg_raw=-0.000747, avg_ip=0.000239, beat_rate=0.106667
...
- `CERTIFIED_CLEAN`: n=9, two_prices=9, avg_raw=-0.018889, avg_ip=0.007822, beat_rate=0.555556
- `SKIPPED_VETO`: n=109, two_prices=106, avg_raw=0.002255, avg_ip=-0.001226, beat_rate=0.066038
