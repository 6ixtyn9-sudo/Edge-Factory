...
- total unique picks: 440
- picks with at least two prices: 400
- average raw odds delta: 0.002077
- average implied-probability delta: -0.000798
- beat-later-price rate: 0.1375
- beat-later-price sample: 400
- unmatched picks: 22
...
- `2way-unanimous avg_p>=70`: n=131, two_prices=118, avg_raw=0.00139, avg_ip=-0.000869, beat_rate=0.135593
- `2way-unanimous min_p>=60 avg_p>=65`: n=11, two_prices=8, avg_raw=0.0, avg_ip=0.0, beat_rate=0.0
- `3way-unanimous avg_p>=65`: n=44, two_prices=42, avg_raw=0.005119, avg_ip=-0.002892, beat_rate=0.02381
- `ml-meta avg_p>=55`: n=160, two_prices=148, avg_raw=0.002973, avg_ip=-0.00076, beat_rate=0.182432
...
- `SKIPPED_VETO`: n=239, two_prices=230, avg_raw=0.002448, avg_ip=-0.001425, beat_rate=0.152174
