...
- **Over 2.5 Goals**: occurred in 183 / 281 matches (65.1%)
- **Both Teams to Score (BTTS)**: occurred in 153 / 281 matches (54.4%)
- **Selected Team Over 1.5 Goals**: occurred in 197 / 281 matches (70.1%)

## Recommended Enhancements Audit

Performance of deep context-derived recommended enhancements overlay:
- **Total Recommended Enhancements**: 249
- **Total Hits**: 202
...
- `match_over_25`: recommended=51, hits=37, hit_rate=72.5%
...
- notes on settled picks: **1629** | scored: 1629

### Per-market hit table

| market | notes | n | hits | realized | promised avg | Δ | Brier |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `away_under_35` | 199 | 199 | 196 | +98.5% | +97.8% | +0.7% | 0.014408 |
| `away_under_25` | 186 | 186 | 174 | +93.5% | +93.7% | -0.2% | 0.061329 |
| `home_over_05` | 181 | 181 | 169 | +93.4% | +87.6% | +5.7% | 0.06675 |
| `match_over_25` | 180 | 180 | 115 | +63.9% | +43.1% | +20.8% | 0.278681 |
| `match_over_45` | 164 | 164 | 42 | +25.6% | +25.1% | +0.5% | 0.193795 |
| `match_over_35` | 98 | 98 | 38 | +38.8% | +43.0% | -4.2% | 0.244783 |
| `away_under_15` | 75 | 75 | 61 | +81.3% | +81.6% | -0.3% | 0.150606 |
...
| --- | --- | --- | --- | --- | --- | --- |
| hybrid_cohort | 1316 | 859 | +65.3% | +62.9% | +2.4% | 0.134766 |
...
| 0.2-0.3 | 209 | +24.8% | +23.9% | -0.9% |
| 0.3-0.4 | 221 | +35.6% | +45.2% | +9.6% |
| 0.4-0.5 | 180 | +44.7% | +50.0% | +5.3% |
| 0.5-0.6 | 93 | +52.6% | +46.2% | -6.3% |
| 0.6-0.7 | 5 | +65.3% | +100.0% | +34.7% |
| 0.7-0.8 | 4 | +74.4% | +50.0% | -24.4% |
| 0.8-0.9 | 256 | +84.4% | +88.3% | +3.9% |
| 0.9-1.0 | 507 | +95.3% | +95.5% | +0.2% |
...
- **Avg Goals forecast**: n=248, MAE=1.443548 goals, bias=-0.354435 (realized − promised), promised avg 3.628629 vs realized 3.274194

### Per-metric calibration

| metric | n | promised avg | realized | Δ | Brier |
| --- | --- | --- | --- | --- | --- |
| Top Scores (exact) | 496 | +15.3% | +9.9% | -5.4% | 0.092074 |
| Away Over 1.5 | 248 | +23.0% | +30.2% | +7.3% | 0.198502 |
| BTTS-Yes | 248 | +41.4% | +54.4% | +13.0% | 0.265497 |
| Home Over 1.5 | 248 | +72.7% | +60.9% | -11.8% | 0.219829 |
| Over 2.5 | 248 | +71.2% | +64.1% | -7.1% | 0.232871 |
...
| 0.1-0.2 | 562 | +14.6% | +12.1% | -2.5% |
| 0.2-0.3 | 6 | +20.8% | +16.7% | -4.1% |
| 0.3-0.4 | 66 | +37.8% | +54.5% | +16.7% |
| 0.4-0.5 | 181 | +42.8% | +54.1% | +11.3% |
| 0.6-0.7 | 124 | +66.9% | +58.1% | -8.8% |
| 0.7-0.8 | 114 | +74.7% | +69.3% | -5.4% |
| 0.8-0.9 | 215 | +85.1% | +68.4% | -16.8% |
...
- `ml-meta avg_p>=60`: settled=4, wins=3, hit_rate=0.75, ROI=-0.0075
...
- `CAUTION`: settled=62, wins=35, hit_rate=0.564516, ROI=-0.099194
...
- `bzzoiro_odds`: settled=88, wins=57, hit_rate=0.647727, ROI=-0.062409
...
- `exact`: settled=136, wins=88, hit_rate=0.647059, ROI=-0.070015
...
| Bzzoiro primary match (`BZZOIRO_PRIMARY`) | 80 | 52 | 0.65 | 80 | -0.04565 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| No price quarantine (`NONE`) | 209 | 151 | 0.722488 | 192 | 0.014885 | 0 | None |
...
- 2026-08-19 `CAUTION` `ml-meta avg_p>=60` — Vila Nova vs Ponte Preta -> HOME @ 1.42 (pending_or_unmatched_result); keys=['vilanova']/['pontepret']
