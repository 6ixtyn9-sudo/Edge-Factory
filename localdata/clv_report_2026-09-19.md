...
- unmatched picks: 74
- picks with fewer than two snapshots: 96

## By rule

- `2way-unanimous avg_p>=70`: n=219, two_prices=163, avg_raw=-0.001288, avg_ip=0.000963, beat_rate=0.165644
- `ml-meta avg_p>=55`: n=617, two_prices=560, avg_raw=-0.002714, avg_ip=0.001575, beat_rate=0.160714
...
- `SKIPPED_VETO`: n=553, two_prices=500, avg_raw=-0.00234, avg_ip=0.00125, beat_rate=0.168
