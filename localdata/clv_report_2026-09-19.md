...
- total unique picks: 1076
- picks with at least two prices: 917
- average raw odds delta: 0.001538
- average implied-probability delta: 0.000479
- beat-later-price rate: 0.140676
- beat-later-price sample: 917
- unmatched picks: 73
- picks with fewer than two snapshots: 86

## By rule

- `2way-unanimous avg_p>=70`: n=218, two_prices=164, avg_raw=-0.00128, avg_ip=0.000957, beat_rate=0.164634
- `ml-meta avg_p>=55`: n=613, two_prices=560, avg_raw=-0.002714, avg_ip=0.001575, beat_rate=0.160714
- `ml-meta avg_p>=60`: n=112, two_prices=91, avg_raw=0.032967, avg_ip=-0.005692, beat_rate=0.065934
...
- `CERTIFIED_CLEAN`: n=105, two_prices=90, avg_raw=0.031, avg_ip=-0.004504, beat_rate=0.166667
- `SKIPPED_VETO`: n=547, two_prices=501, avg_raw=-0.002335, avg_ip=0.001247, beat_rate=0.167665
...
- `WATCHLIST_UNCORROBORATED_PRICE`: n=216, two_prices=199, avg_raw=-0.002864, avg_ip=0.001213, beat_rate=0.060302
