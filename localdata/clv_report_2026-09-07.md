...
- average raw odds delta: 0.003976
- average implied-probability delta: -0.000458
- beat-later-price rate: 0.152632
...
- `2way-unanimous avg_p>=70`: n=188, two_prices=156, avg_raw=-0.000513, avg_ip=0.000236, beat_rate=0.166667
- `2way-unanimous min_p>=60 avg_p>=65`: n=11, two_prices=8, avg_raw=0.0, avg_ip=0.0, beat_rate=0.0
- `3way-unanimous avg_p>=65`: n=12, two_prices=12, avg_raw=0.0025, avg_ip=-0.00106, beat_rate=0.0
- `ml-meta avg_p>=55`: n=447, two_prices=416, avg_raw=0.000457, avg_ip=0.000233, beat_rate=0.177885
...
- `CAUTION`: n=118, two_prices=108, avg_raw=0.006019, avg_ip=-0.000797, beat_rate=0.148148
- `CERTIFIED_CLEAN`: n=71, two_prices=62, avg_raw=0.044323, avg_ip=-0.006799, beat_rate=0.225806
- `SKIPPED_VETO`: n=428, two_prices=406, avg_raw=-0.000433, avg_ip=0.000135, beat_rate=0.182266
