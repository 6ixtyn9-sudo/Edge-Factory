...
- `ml-meta avg_p>=55`: n=564, two_prices=512, avg_raw=-0.003086, avg_ip=0.001714, beat_rate=0.171875
...
- `CERTIFIED_CLEAN`: n=90, two_prices=74, avg_raw=0.036351, avg_ip=-0.004989, beat_rate=0.202703
- `SKIPPED_VETO`: n=499, two_prices=460, avg_raw=-0.00263, avg_ip=0.001332, beat_rate=0.180435
