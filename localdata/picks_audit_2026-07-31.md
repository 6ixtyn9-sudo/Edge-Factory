...
- 2026-07-30 `SKIPPED_VETO` `3way-unanimous avg_p>=65` — Benfica vs FC ST. Gallen -> HOME @ 1.17 (unmatched_result); keys=['benfica', 'slbenfica']/['stgallen']
- 2026-07-30 `SKIPPED_VETO` `3way-unanimous avg_p>=65` — Hibernian vs Malisheva -> HOME @ 1.25 (unmatched_result); keys=['hibernian']/['malisheva']
- 2026-07-30 `SKIPPED_VETO` `3way-unanimous avg_p>=65` — FC Sion vs BATE Borisov -> HOME @ 1.125 (unmatched_result); keys=['sion']/['bateboris']
- 2026-07-30 `WATCHLIST_UNKNOWN_CTX` `2way-unanimous avg_p>=70` — SC Braga vs Železničar Pančevo -> HOME @ 1.21 (unmatched_result); keys=['braga']/['elezniarp', 'zeleznica']
- 2026-07-30 `WATCHLIST_UNKNOWN_CTX` `2way-unanimous avg_p>=70` — Austria Vienna vs FK Liepaja -> HOME @ 1.24 (unmatched_result); keys=['austriavi']/['fkliepaja']
