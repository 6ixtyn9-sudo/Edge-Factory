...
- total unique picks: 865
- picks with at least two prices: 755
- average raw odds delta: 0.003658
- average implied-probability delta: -0.000208
- beat-later-price rate: 0.162914
...
- `ml-meta avg_p>=55`: n=488, two_prices=452, avg_raw=-0.000553, avg_ip=0.0008, beat_rate=0.190265
...
- `CERTIFIED_CLEAN`: n=73, two_prices=63, avg_raw=0.04473, avg_ip=-0.007025, beat_rate=0.238095
- `SKIPPED_VETO`: n=431, two_prices=402, avg_raw=-0.001184, avg_ip=0.000594, beat_rate=0.19403
