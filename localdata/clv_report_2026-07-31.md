...
- total unique picks: 115
- picks with at least two prices: 105
- average raw odds delta: 0.006143
- average implied-probability delta: -0.002734
...
- `3way-unanimous avg_p>=65`: n=22, two_prices=21, avg_raw=0.005952, avg_ip=-0.003626, beat_rate=0.0
...
- `SKIPPED_VETO`: n=88, two_prices=81, avg_raw=0.007593, avg_ip=-0.003309, beat_rate=0.0
