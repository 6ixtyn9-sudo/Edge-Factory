...
- archived pick rows: 485
- archived pick dates: 30
- immutable morning-baseline rows: 357
...
- settled via shared overlay facts: 90
...
- **Over 2.5 Goals**: occurred in 289 / 451 matches (64.1%)
- **Both Teams to Score (BTTS)**: occurred in 246 / 451 matches (54.5%)
- **Selected Team Over 1.5 Goals**: occurred in 316 / 451 matches (70.1%)

## Recommended Enhancements Audit

Performance of deep context-derived recommended enhancements overlay:
- **Total Recommended Enhancements**: 460
- **Total Hits**: 342
...
- `match_over_25`: recommended=252, hits=166, hit_rate=65.9%
...
- notes on settled picks: **2506** | scored: 2506

### Per-market hit table

| market | notes | n | hits | realized | promised avg | Δ | Brier |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `match_over_25` | 402 | 402 | 258 | 64.2% | 46.5% | +17.6% | 0.261756 |
| `away_under_35` | 353 | 353 | 345 | 97.7% | 98.0% | -0.3% | 0.02155 |
| `match_over_45` | 339 | 339 | 92 | 27.1% | 24.6% | +2.6% | 0.199297 |
| `away_under_25` | 334 | 334 | 313 | 93.7% | 94.1% | -0.4% | 0.059507 |
| `home_over_05` | 333 | 333 | 301 | 90.4% | 86.5% | +3.9% | 0.088282 |
| `away_under_15` | 123 | 123 | 98 | 79.7% | 81.4% | -1.7% | 0.162248 |
| `home_under_35` | 102 | 102 | 101 | 99.0% | 95.3% | +3.7% | 0.01123 |
| `home_under_25` | 89 | 89 | 82 | 92.1% | 91.8% | +0.3% | 0.073265 |
...
| --- | --- | --- | --- | --- | --- | --- |
| hybrid_cohort | 2336 | 1631 | 69.8% | 66.8% | +3.0% | 0.131505 |
...
| 0.2-0.3 | 285 | 25.1% | 27.4% | +2.3% |
| 0.3-0.4 | 218 | 35.5% | 42.2% | +6.7% |
| 0.4-0.5 | 288 | 45.6% | 56.9% | +11.4% |
| 0.5-0.6 | 162 | 53.0% | 59.9% | +6.9% |
| 0.6-0.7 | 6 | 62.5% | 66.7% | +4.2% |
| 0.8-0.9 | 456 | 84.3% | 87.1% | +2.8% |
| 0.9-1.0 | 913 | 95.5% | 95.8% | +0.3% |
...
- **Avg Goals forecast**: n=450, MAE=1.531044 goals, bias=-0.222422 (realized − promised), promised avg 3.575756 vs realized 3.353333

### Per-metric calibration

| metric | n | promised avg | realized | Δ | Brier |
| --- | --- | --- | --- | --- | --- |
| Away Over 1.5 | 450 | 27.0% | 36.2% | +9.2% | 0.206745 |
| BTTS-Yes | 450 | 41.4% | 54.7% | +13.3% | 0.266646 |
| Home Over 1.5 | 450 | 68.1% | 59.1% | -9.0% | 0.239315 |
| Over 2.5 | 450 | 70.5% | 64.0% | -6.5% | 0.232269 |

### Promised-vs-realized calibration (all 📊 metrics pooled)

| promised bucket | n | promised avg | realized | Δ |
| --- | --- | --- | --- | --- |
| 0.0-0.1 | 294 | 8.8% | 23.5% | +14.6% |
| 0.1-0.2 | 158 | 10.5% | 29.7% | +19.3% |
| 0.2-0.3 | 4 | 21.2% | 25.0% | +3.8% |
| 0.3-0.4 | 108 | 37.4% | 57.4% | +20.0% |
| 0.4-0.5 | 336 | 43.0% | 53.9% | +10.8% |
| 0.6-0.7 | 258 | 66.8% | 60.5% | -6.3% |
| 0.7-0.8 | 175 | 74.8% | 66.9% | -7.9% |
| 0.8-0.9 | 408 | 84.8% | 68.6% | -16.2% |
| 0.9-1.0 | 59 | 91.8% | 84.7% | -7.1% |

## By rule

- `2way+bc-confirms avg_p>=60`: settled=33, wins=19, hit_rate=0.575758, ROI=-0.213548
- `2way-unanimous avg_p>=70`: settled=133, wins=103, hit_rate=0.774436, ROI=0.074034
...
- `SKIPPED_VETO`: settled=234, wins=165, hit_rate=0.705128, ROI=-0.008491
...
- `betexplorer_odds`: settled=154, wins=106, hit_rate=0.688312, ROI=-0.036429
...
- `betexplorer`: settled=154, wins=106, hit_rate=0.688312, ROI=-0.036429
...
| --- | --- | --- | --- | --- | --- |
| BetExplorer rescue (`BETEXPLORER_RESCUE`) | 154 | 106 | 0.688312 | 154 | -0.036429 |
...
| --- | --- | --- | --- | --- | --- |
| **overall (SKIPPED_VETO)** | 234 | 165 | 0.705128 | 232 | -0.008491 |
| **trusted evidence only** | 124 | 88 | 0.709677 | 124 | -0.019355 |
| **soft evidence only** | 110 | 77 | 0.7 | 108 | 0.003981 |
| evidence: BETEXPLORER_RESCUE | 82 | 59 | 0.719512 | 82 | -0.038171 |
...
| odds band: <1.50 | 153 | 119 | 0.777778 | 153 | 0.003137 |
...
| veto reason: context VETO in ['league'] | 12 | 7 | 0.583333 | 11 | -0.041818 |
| veto reason: context VETO in ['niche'] | 3 | 1 | 0.333333 | 3 | -0.426667 |
| veto reason: context VETO in ['odds_band', 'niche'] | 2 | 2 | 1.0 | 2 | 0.235 |
| veto reason: context VETO in ['odds_band'] | 51 | 42 | 0.823529 | 51 | 0.096863 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| No price quarantine (`NONE`) | 285 | 195 | 0.684211 | 257 | -0.02358 | 0 | None |
...
- 2026-08-29 `WATCHLIST_UNCORROBORATED_PRICE` `2way-unanimous avg_p>=70` — Viking vs Aalesund -> HOME @ 1.3 (pending_or_unmatched_result); keys=['viking']/['aalesund']
