...
- **Total Recommended Enhancements**: 450
- **Total Hits**: 335
...
- `match_over_25`: recommended=245, hits=162, hit_rate=66.1%
...
- notes on settled picks: **2468** | scored: 2468

### Per-market hit table

| market | notes | n | hits | realized | promised avg | Δ | Brier |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `match_over_25` | 393 | 393 | 253 | 64.4% | 46.5% | +17.9% | 0.261932 |
| `away_under_35` | 344 | 344 | 336 | 97.7% | 98.1% | -0.4% | 0.022064 |
| `away_under_25` | 331 | 331 | 310 | 93.7% | 94.1% | -0.5% | 0.059952 |
| `match_over_45` | 331 | 331 | 90 | 27.2% | 24.6% | +2.6% | 0.199671 |
| `home_over_05` | 330 | 330 | 299 | 90.6% | 86.5% | +4.1% | 0.08654 |
| `away_under_15` | 123 | 123 | 98 | 79.7% | 81.4% | -1.7% | 0.162248 |
| `home_under_35` | 97 | 97 | 96 | 99.0% | 95.4% | +3.5% | 0.011533 |
...
| --- | --- | --- | --- | --- | --- | --- |
| hybrid_cohort | 2332 | 1628 | 69.8% | 66.9% | +3.0% | 0.13159 |
| model | 85 | 62 | 72.9% | 54.8% | +18.2% | 0.255448 |
...
| --- | --- | --- | --- | --- |
| 0.1-0.2 | 176 | 16.7% | 19.3% | +2.6% |
| 0.2-0.3 | 280 | 25.1% | 27.1% | +2.0% |
| 0.3-0.4 | 217 | 35.5% | 42.4% | +6.9% |
| 0.4-0.5 | 283 | 45.6% | 56.9% | +11.3% |
| 0.5-0.6 | 158 | 53.0% | 60.1% | +7.1% |
| 0.6-0.7 | 6 | 62.5% | 66.7% | +4.2% |
| 0.8-0.9 | 451 | 84.3% | 87.1% | +2.8% |
| 0.9-1.0 | 897 | 95.6% | 95.8% | +0.2% |
...
- `CAUTION`: settled=71, wins=46, hit_rate=0.647887, ROI=0.010423
...
- `WATCHLIST_UNCORROBORATED_PRICE`: settled=68, wins=46, hit_rate=0.676471, ROI=-0.017059
...
- `forebet_best`: settled=27, wins=20, hit_rate=0.740741, ROI=0.030741
- `scoutingstats_odds`: settled=155, wins=106, hit_rate=0.683871, ROI=-0.02071
...
- `exact`: settled=228, wins=153, hit_rate=0.671053, ROI=-0.027807
- `fallback`: settled=25, wins=20, hit_rate=0.8, ROI=0.118
...
| ScoutingStats sole fallback (`SCOUTINGSTATS_SOLE`) | 155 | 106 | 0.683871 | 155 | -0.02071 |
| Source fallback (`SOURCE_FALLBACK`) | 25 | 20 | 0.8 | 25 | 0.118 |
...
| --- | --- | --- | --- | --- | --- |
| **overall (SKIPPED_VETO)** | 233 | 165 | 0.708155 | 231 | -0.004199 |
| **trusted evidence only** | 123 | 88 | 0.715447 | 123 | -0.011382 |
| **soft evidence only** | 110 | 77 | 0.7 | 108 | 0.003981 |
| evidence: BETEXPLORER_RESCUE | 81 | 59 | 0.728395 | 81 | -0.026296 |
...
| odds band: <1.50 | 152 | 119 | 0.782895 | 152 | 0.009737 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| No price quarantine (`NONE`) | 279 | 192 | 0.688172 | 251 | -0.019084 | 0 | None |
| alias_fuzzy match (`alias_fuzzy`) | 16 | 12 | 0.75 | 15 | 0.057333 | 13 | 1.376538 |
| ScoutingStats sole source (`scoutingstats_sole_source`) | 155 | 106 | 0.683871 | 155 | -0.02071 | 0 | None |
